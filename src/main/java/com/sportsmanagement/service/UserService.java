...
import com.sportsmanagement.dao.UserDao;
...
public class UserService {
	...
	public List<User> getUsersByRoleAndSportsId(String role, int sportsId) {
		return this.userDao.findByRoleAndSportsId(role, sportsId);
	}
